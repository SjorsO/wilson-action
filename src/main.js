...
export async function run() {
  try {
    ...
    const phpExecutable = core.getInput('php-executable')
    const beforeWorkerTests = core.getInput('before-worker-tests')
    ...
    form.append('before_worker_tests', beforeWorkerTests)
